...
% OPTIONS.starSimFile      = 'Mezzanine_v3.sim';          % name of empty STAR-CCM+ sim file
OPTIONS.starSimFile      = 'mezzanine.sim';          % name of empty STAR-CCM+ sim file, I think a blank one can be created automatically
